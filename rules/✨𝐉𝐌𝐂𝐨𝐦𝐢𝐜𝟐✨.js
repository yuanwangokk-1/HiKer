const csdown = {
    ...
    var 首页 = [
      {
        title: "首页&分类&每周必看",
        id: "1&2&3&4&5",
        img: "https://raw.githubusercontent.com/ls125781003/tubiao/main/more/47.png&https://raw.githubusercontent.com/ls125781003/tubiao/main/more/78.png&https://raw.githubusercontent.com/ls125781003/tubiao/main/more/109.png",
      },
    ];
    if (MY_PAGE == 1) {
          ...
          js: $.toString(() => {
            ...
            let Line = {
              ...
              js: $.toString(() => {
                ...
                var url =
                  "https://www.cdnblackmyth.club|https://www.cdnmhwscc.vip|https://www.cdnmhws.cc|https://www.cdnuc.vip".split(
                    "|"
                  );
          ...
          promote_data.forEach((data) => {
            ...
            content.forEach((data) => {
              d.push({
                ...
                img:
                  getItem("img_host") + "/media/albums/" + data.id + "_3x4.jpg",
    ...
    var pic = $("").lazyRule(() => {
      ...
      try {
        ...
        for (item of data.images) {
          var picUrl =
            getItem("img_host") + "/media/photos/" + input + "/" + item;
  ...
  erji: () => {
    ...
    try {
      ...
      d.push({
        ...
        desc:
          `❤️ ${data.likes}喜欢  ${data.comment_total}评论  ${data.total_views}观看 \n` +
      ...
      d.push({
        ...
        url: $("hiker://empty?page=fypage").rule(() => {
          ...
          let id = MY_PARAMS.id;
          let url =
            getItem("host") + "/forum?page=" + pg + "&mode=manhua&aid=" + id;
          let list = post(url).list;
          list.forEach((data) => {
            d.push({
              title: data.nickname,
    ...
    try {
      ...
      if (MY_PAGE == 1) {
        ...
        storage0.getItem("cate").categories.forEach((data, index) => {
          d.push({
            title:
              getMyVar("cate_", getMyVar("cate_n")) == data.slug
        ...
        if (
          storage0.getItem("cate").categories[getMyVar("cate_index", "0")]
            .sub_categories != null
        ) {
          let subcate =
            storage0.getItem("cate").categories[getMyVar("cate_index", "0")]
          ...
          d.push({
            title:
              getMyVar("subcate_" + getMyVar("cate_index", "0"), "") == ""
                ? strong("全部", "FF6699")
                : "全部",
            url: $("#noLoading#").lazyRule(() => {
          ...
          subcate.forEach((data) => {
            d.push({
              ...
              url: $("#noLoading#").lazyRule(
                ...
                "subcate_" + getMyVar("cate_index", "0"),
                data.name,
                "_" + data.slug + ""
              ),
              col_type: "scroll_button",
    ...
    try {
      ...
      if (MY_PAGE == 1) {
        ...
        d.push({
          title: getMyVar(
            "time_",
            storage0.getItem("week").categories[0].time +
              storage0.getItem("week").categories[0].title
          ),
          url: $("#noLoading#").lazyRule(() => {
            let option = [];
      ...
      let filter_url =
        ...
        pg +
        "&id=" +
        getMyVar("week_id", getMyVar("week_index")) +
        "&type=" +
        getMyVar("week_", "hanman");
  ...
  decodeimg: (picUrl, imgInputStream) => {
    ...
    let newImgBitmap = Bitmap.createBitmap(
      width,
      height,
    ...
    for (let i = 1; i <= $num; i++) {
      ...
      canvas.drawBitmap(
        Bitmap.createBitmap(imgBitmap, 0, y * (i - 1), width, y + h),
        0,
        height - y * i - h,
        null
      );
