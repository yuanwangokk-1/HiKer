const hxc = {
    ...
    var c1 = [
      {
        ...
        id: "1&2&3&4&5",
        img: "https://raw.githubusercontent.com/ls125781003/tubiao/main/more/47.png&https://raw.githubusercontent.com/ls125781003/tubiao/main/more/74.png&https://raw.githubusercontent.com/ls125781003/tubiao/main/more/30.png&https://raw.githubusercontent.com/ls125781003/tubiao/main/more/9.png&https://raw.githubusercontent.com/ls125781003/tubiao/main/more/7.png",
      },
    ];
    if (MY_PAGE == 1) {
  ...
  video: () => {
    ...
    try {
      ...
      let getlist_body =
        ...
        ',"page":' +
        pg +
        ',"payType":[1,2,3,4],"tagIds":[],"tags":[],"type":0,"typeIds":[' +
        getMyVar("首页视频", "") +
        '],"videoIds":[]}';
  ...
  subject: () => {
    ...
    try {
      ...
      let subject_body =
        '{"length":16,"orderType":3,"page":1,"subjectIds":[71,68,67,66,65,62,69,64,11,2]}';
  ...
  heji: () => {
    ...
    try {
      ...
      let heji_body =
        '{"gatherIds":[],"gatherType":1,"length":20,"orderType":3,"page":' +
        pg +
        "}";
  ...
  actor: () => {
    ...
    try {
      ...
      let actor_body =
        '{"filterIds":[],"groupIds":[1],"isManualBack":0,"length":20,"page":' +
        pg +
        ',"uids":[]}';
  ...
  mini: () => {
    ...
    try {
      ...
      let getlist_url = getItem("host") + "/videos/getList";
      let getlist_body =
        '{"footId":2,"length":' + num + ',"page":' + pg + ',"type":7}';
      let list = post(getlist_url, getlist_body).data.list;
      list.forEach((data) => {
        d.push({
          title: data.name,
