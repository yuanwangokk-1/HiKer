const csdown = {
  ...
  aes: $.toString(() => {
    ...
    var image = $("").image(() => {
      ...
      return CryptoUtil.Data.parseBase64(
        decode(textData),
        _base64.NO_WRAP
      ).toInputStream();
    });
    ...
    function post(url, body) {
      ...
      var html = fetch(url, {
        headers: {
          ...
          "User-Agent":
            "Mozilla/5.0 (Linux; Android 15; 24031PN0DC Build/AQ3A.240627.003; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/130.0.6723.86 Mobile Safari/537.36;SuiRui/d/ver=5.6.9",
        },
        body: body,
    ...
    var pic = $("").lazyRule(() => {
      eval($.require("csdown").rely($.require("csdown").aes));
      let url =
        getItem("host") + "/api/comics/base/chapterInfo?chapterId=" + input;
  ...
  search: () => {
    ...
    let url =
      getItem("host") +
      "/api/video/queryVideoByTitle?pageSize=30&title=" +
      getMyVar("keyword") +
      "&videoType=1";
    try {
      let data = post(url);
    ...
    try {
      if (MY_PAGE == 1) {
        ...
        if (getMyVar("精选", "1") == "1") {
            ...
            d.push({
              ...
              url: $("hiker://empty?page=fypage").rule(() => {
                ...
                if (id == 1) {
                  ...
                  let url =
                    getItem("host") +
                    "/api/video/getGoldVideo?pageSize=30&lastId=0&sortBy=" +
                    getMyVar("金币", "1");
                  ...
                  new_.forEach((data) => {
                    d.push({
                      ...
                      url: $("hiker://empty?page=fypage").rule(() => {
                        ...
                        let url =
                          getItem("host") +
                          "/api/video/queryNewVideoMore?pageSize=30&page=" +
                          pg +
                          "&recommendDate=" +
                          id;
          ...
          let choice_url =
            getItem("host") + "/api/video/choice/list?choiceType=0";
      ...
      if (getMyVar("精选", "1") == "2") {
        let exclusiveList_url =
          getItem("host") + "/api/video/exclusiveList?pageSize=30&page=" + pg;
  ...
  exclusive: () => {
    ...
    let url =
      getItem("host") +
      "/api/video/exclusiveStationVideo?pageSize=30&page=" +
      pg +
      "&stationId=" +
      id;
    try {
  ...
  choice: () => {
    ...
    if (MY_PAGE == 1) {
      ...
      let body =
        ...
        ',"choiceSort":' +
        getMyVar("推荐二级分类", "1") +
        ',"hotspotId":0,"hotspotSort":0,"pageSize":100,"videoIds":[]}';
      try {
  ...
  netYellow: () => {
    ...
    if (getMyVar("网黄", "1") == 1) {
      let url =
        getItem("host") +
        "/api/video/userWorks?pageSize=30&userId=" +
        id +
        "&page=" +
        pg;
      try {
      ...
      let url =
        getItem("host") +
        "/api/user/portray/user?pageSize=21&userId=" +
        id +
        "&page=" +
        pg;
      try {
    ...
    try {
      if (MY_PAGE == 1) {
        if (!storage0.getItem("classify_")) {
          ...
          classify =
            getItem("host") + "/api/av/classify/getProhibitClassifyList";
            ...
            js: $.toString(() => {
              if (getItem("open", "0") == "0") {
                confirm({
                  ...
                  confirm: $.toString(() => {
                    setItem("open", "1");
                    let classify = storage0
                      .getItem("classify_0")
                      .concat(storage0.getItem("classify_1"));
                    log(classify);
        ...
        storage0.getItem("classify_").forEach((data) => {
          d.push({
            title:
              getMyVar("classify", getMyVar("index_classify")) ==
              data.classifyId + ""
      ...
      if (Arr_0.includes(getMyVar("classify", getMyVar("index_classify")))) {
        let url =
          getItem("host") +
          "/api/st/getStStations?classifyId=" +
          getMyVar("classify", getMyVar("index_classify"));
        ...
        Arr_1.includes(getMyVar("classify", getMyVar("index_classify")))
      ) {
        let tags_url =
          getItem("host") +
          "/api/av/classify/getProhibitTagsList?classifyId=" +
          getMyVar("classify", getMyVar("index_classify")).replace("3", "");
        ...
        tags.forEach((data) => {
          d.push({
            ...
            url: $("hiker://empty?page=fypage").rule(() => {
              ...
              let url =
                getItem("host") +
                "/api/video/prohibitTagsVideoList?page=" +
                pg +
                "&pageSize=20&classifyId=" +
                id +
                "&tagTitle=" +
                title;
              let list = post(url).list;
            ...
            extra: {
              title: data.tagsTitle,
              id: getMyVar("classify", getMyVar("index_classify")).replace(
                "3",
                ""
              ),
            },
        ...
        list.forEach((data) => {
          d.push({
            ...
            url:
              data.videoUrl != ""
                ? getItem("host") + "/api/m3u8/h5/decode?path=" + data.videoUrl
                : data.videoId + vod,
            img: getItem("imgDomain") + data.coverImg[0] + "_480" + image,
            col_type: "movie_2",
          });
        ...
        let url =
          getItem("host") +
          "/api/st/getStClassifyVideo?pageSize=20&page=" +
          pg +
          "&classifyId=" +
          getMyVar("classify", getMyVar("index_classify"));
        let list = post(url).data;
  ...
  videoerji: () => {
    ...
    let url =
      getItem("host") +
      "/api/st/getStStationMore?stationId=" +
      id +
      "&lastId=0&pageSize=30";
    try {
      let data = post(url).data;
      data.forEach((data) => {
        d.push({
  ...
  topic: () => {
    ...
    try {
        ...
        storage0.getItem("topic_").forEach((data) => {
          d.push({
            ...
            img:
              data.topicLogo == null
                ? getItem("imgDomain") +
                  "image/o5/gj/zk/eo/250fd5aace414574943cdb4cd83bba25.png_480" +
                  image
                : getItem("imgDomain") + data.topicLogo + "_480" + image,
            url: $("hiker://empty?page=fypage").rule(() => {
              var d = $.require("csdown").d;
              eval($.require("csdown").rely($.require("csdown").aes));
              let id = MY_PARAMS.id;
              ...
              let url =
                getItem("host") +
                "/api/meet/bar/dynamic/list/v2?topicId=" +
                id +
                "&page=" +
                pg +
                "&pageSize=10";
              ...
              topic.forEach((data) => {
                    ...
                    img:
                      data.logo == null
                        ? getItem("imgDomain") +
                          "image/o5/gj/zk/eo/250fd5aace414574943cdb4cd83bba25.png_480" +
                          image
                        : getItem("imgDomain") + data.logo + "_480" + image,
                ...
                if (data.video) {
                  d.push({
                    title:
                      "视频长:" +
                      parseInt(data.video.playTime / 60) +
                      ":" +
                      parseInt(data.video.playTime % 60),
                    desc: "0",
                    img:
                      getItem("imgDomain") +
                      data.video.coverImg[0] +
                      "_480" +
                      image,
                    url:
                      getItem("host") +
      ...
      let url =
        getItem("host") +
        "/api/meet/bar/dynamic/list/v2?loadType=" +
        getMyVar("社区分类", "2") +
        "&page=" +
        pg +
        "&pageSize=15";
  ...
  topicerji: () => {
    ...
    let id = MY_PARAMS.id;
    let url =
      getItem("host") + "/api/meet/bar/dynamic/getDynamicInfo?dynamicId=" + id;
    try {
      ...
      if (data.video) {
        d.push({
          ...
          img: getItem("imgDomain") + data.video.coverImg[0] + "_480" + image,
          url:
            getItem("host") + "/api/m3u8/h5/decode?path=" + data.video.videoUrl,
          col_type: "card_pic_1",
          extra: {
            id: data.dynamicId,
          },
  ...
  uperji: () => {
    ...
    let url =
      getItem("host") +
      "/api/community/dynamic/person/list?userId=" +
      id +
      "&type=0&page=" +
      pg +
      "&pageSize=10";
    try {
      ...
      if (getMyVar("up", "1") == 1) {
        let url =
          getItem("host") +
          "/api/meet/bar/dynamic/person/list?userId=" +
          id +
          "&page=" +
          pg +
          "&pageSize=10";
        ...
        list.forEach((data) => {
          ...
          if (data.video) {
            d.push({
              ...
              desc: "0",
              img:
                getItem("imgDomain") + data.video.coverImg[0] + "_480" + image,
              url:
                getItem("host") +
                "/api/m3u8/h5/decode?path=" +
                data.video.videoUrl,
    ...
    list.forEach((data) => {
      d.push({
        ...
        url: $("hiker://empty?page=fypage").rule(() => {
          ...
          let url =
            getItem("host") +
            "/api/featuredPortray/stationPortrayMore?pageSize=30&page=" +
            pg +
            "&stationId=" +
            id;
          try {
