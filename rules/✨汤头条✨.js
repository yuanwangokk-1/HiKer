const csdown = {
  ...
  aes: $.toString(() => {
    ...
    var lazy = $("").lazyRule(() => {
      ...
      var data0 =
        '{"id":"' +
        input +
        '","system_oauth_type":"pwa","system_oauth_id":"DJ1iNBf5HiuIjSs7_1715823105441","system_oauth_new_id":"","system_version":"3.0.1","system_app_type":"","system_build":"","system_build_id":""}';
      var url = getItem("host") + "/pwa.php/api/MvDetail/detail";
      let html = post(url, data0);
      var url1 = JSON.parse(html)
        .data.detail.preview_video.replace(/\/\/.*play\./, "//long.")
        .replace("&seconds=30", "");
      return url1;
    });
    ...
    function post(url, data0) {
      ...
      var body =
        "client=pwa&timestamp=" + t + "&data=" + data + "&sign=" + sign;
  ...
  search: () => {
    ...
    try {
      ...
      if (
        (getMyVar("搜索", "long") == "long") |
        (getMyVar("搜索", "long") == "small")
      ) {
        var data0 =
          '{"system_version":"3.0.1","system_token":"","system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"R3O2lxhWUaSamr8m3ih_1743502699655","system_app_type":"","system_build":"","system_build_id":"","page":' +
          pg +
          ',"size":10,"limit":10,"keyword":"' +
          getMyVar("keyword") +
          '","type":"' +
          getMyVar("搜索", "long") +
          '"}';
        ...
        list.forEach((data) => {
          ...
          d.push({
            ...
            desc:
              "回复：" +
              (data.reply == undefined ? data.comment_number : data.reply),
            url:
              data.imagesFull == "undefined"
                ? 'hiker://empty?page=fypage&#noHistory#@rule=js:$.require("csdown").wei_erji()'
                : "hiker://empty",
            col_type: "text_1",
            extra: {
              lineVisible: false,
          ...
          try {
            ...
            d.push({
              title: mv.title,
              desc:
                (mv.created_at || mv.refresh_at) +
                "\t\t\t" +
                mv.duration_str +
                "\t\t\t" +
                mv.tags,
              img: mv.thumb_cover_str + image,
              url: mv.preview_video
                .replace(/\/\/.*play\./, "//long.")
                .replace("&seconds=30", ""),
    ...
    try {
      if (MY_PAGE == 1) {
        ...
        cate_video_title.forEach((title, index) => {
          d.push({
            title: title,
            url:
              'hiker://empty?page=fypage@rule=js:$.require("csdown").' +
              cate_video_id[index] +
              "()",
            col_type: "text_3",
          });
      ...
      if ((getMyVar("c2", "111") == 111) | (getMyVar("c2", "111") == 222)) {
        var data0 =
          '{"page":"' +
          pg +
          '","_t":"1","system_oauth_type":"pwa","system_oauth_id":"DJ1iNBf5HiuIjSs7_1715823105441","system_oauth_new_id":"","system_version":"3.0.1","system_app_type":"","system_build":"","system_build_id":""}';
        ...
        if (getMyVar("c2", "111") == 3) {
          var data0 =
            '{"system_version":"3.0.1","system_token":null,"system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"aaCidFG3mAldGW405wx_1743160264138","system_app_type":"","system_build":"","system_build_id":"","page":' +
            pg +
            ',"_t":1}';
          ...
          var data0 =
            '{"system_oauth_type":"pwa","system_oauth_id":"DJ1iNBf5HiuIjSs7_1715823105441","system_oauth_new_id":"","system_version":"3.0.1","system_app_type":"","system_build":"","system_build_id":"","page":"' +
            pg +
            '","tabId":"' +
            getMyVar("c2", "111") +
            '"}';
  ...
  mini: () => {
    ...
    if (storage0.getItem("small_video") == "") {
      let small_video_body =
        '{"system_version":"3.0.1","system_token":"","system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"R3O2lxhWUaSamr8m3ih_1743502699655","system_app_type":"","system_build":"","system_build_id":""}';
      let small_video_url = getItem("host") + "/pwa.php/api/MvList/smallByTag";
      let small_video_data = JSON.parse(post(small_video_url, small_video_body))
        .data.list;
    ...
    if (MY_PAGE == 1) {
      ...
      storage0.getItem("small_video").forEach((data) => {
        d.push({
          title:
            getMyVar("短视频", getMyVar("mini_index")) == data.value + ""
    ...
    var data0 =
      '{"system_version":"3.0.1","system_token":"","system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"R3O2lxhWUaSamr8m3ih_1743502699655","system_app_type":"","system_build":"","system_build_id":"","page":' +
      pg +
      ',"size":10,"limit":10,"tag":"' +
      getMyVar("短视频", getMyVar("mini_index")) +
      '"}';
  ...
  news: () => {
    ...
    if (storage0.getItem("news_" + getMyVar("社区", "0")) == "") {
      ...
      let cate_body =
        '{"system_version":"3.0.1","system_token":null,"system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"aaCidFG3mAldGW405wx_1743160264138","system_app_type":"","system_build":"","system_build_id":"","p_type":' +
        getMyVar("社区", "0") +
        "}";
    ...
    if (MY_PAGE == 1) {
      ...
      let index_n =
        storage0.getItem("news_" + getMyVar("社区", "0"))[0].params_list
          .cate_id + "";
      ...
      storage0.getItem("news_" + getMyVar("社区", "0")).forEach((data) => {
        d.push({
          title:
            getMyVar(
              "社区分类" + getMyVar("社区", "0"),
              getMyVar("news_index_" + getMyVar("社区", "0"))
            ) ==
            data.params_list.cate_id + ""
              ? strong(data.name, "FF6699")
              : data.name,
          url: $("#noLoading#").lazyRule(
            (title, id, api) => {
      ...
      if (
        ...
        let topics_body =
          '{"system_version":"3.0.1","system_token":null,"system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"aaCidFG3mAldGW405wx_1743160264138","system_app_type":"","system_build":"","system_build_id":"","tag":"recommend","more":"no","p_type":' +
          getMyVar("社区", "0") +
          ',"p_id":' +
          getMyVar(
            "社区分类" + getMyVar("社区", "0"),
    ...
    try {
      ...
      var url =
        ...
        getMyVar(
          "社区api",
          storage0.getItem("news_" + getMyVar("社区", "0"))[0].api_list
        );
      var html = post(url, data0);
      var list = JSON.parse(html).data;
      list.forEach((data) => {
  ...
  news_erji: () => {
    ...
    var data0 =
      '{"system_version":"3.0.1","system_token":null,"system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"aaCidFG3mAldGW405wx_1743160264138","system_app_type":"","system_build":"","system_build_id":"","id":"' +
      id +
      '"}';
  ...
  wei_erji: () => {
    ...
    if (MY_PAGE == 1) {
      let data0 =
        '{"system_version":"3.0.1","system_token":"","system_oauth_new_id":"","system_oauth_type":"pwa","system_oauth_id":"R3O2lxhWUaSamr8m3ih_1743502699655","system_app_type":"","system_build":"","system_build_id":"","find_id":"' +
        id +
        '"}';
  ...
  vodlei: () => {
    ...
    if (storage0.getItem("cate_") == "") {
      var data0 =
        '{"system_oauth_type":"pwa","system_oauth_id":"DJ1iNBf5HiuIjSs7_1715823105441","system_oauth_new_id":"","system_version":"3.0.1","system_token":"","system_app_type":"","system_build":"","system_build_id":""}';
  ...
  heji: () => {
    ...
    try {
      var data0 =
        '{"page":"' +
        pg +
        '","sort":"new","system_oauth_type":"pwa","system_oauth_id":"DJ1iNBf5HiuIjSs7_1715823105441","system_oauth_new_id":"","system_version":"3.0.1","system_token":"","system_app_type":"","system_build":"","system_build_id":""}';
    ...
    try {
      ...
      if (getMyVar("video_up", "1") == 1) {
        ...
        var data0 =
          '{"size":"15","uuid":"' +
          id +
          '","lastId":"","system_oauth_type":"pwa","lastId":"' +
          p0 +
          '","system_oauth_id":"DJ1iNBf5HiuIjSs7_1715823105441","system_oauth_new_id":"","system_version":"3.0.1","system_token":"","system_app_type":"","system_build":"","system_build_id":""}';
  ...
  erji2: () => {
    ...
    list.forEach((data) => {
      ...
      d.push({
        title: data.title,
        desc:
          (data.created_at || data.refresh_at) + "\t\t\t" + data.duration_str,
        img: data.thumb_cover_str + image,
        url: url.replace(/\/\/.*play\./, "//long.").replace("&seconds=30", ""),
      });
    });
  ...
  erji3: () => {
    ...
    var data0 =
      ...
      '","size":"15","id":"' +
      id +
      '","orderBy":"id","system_oauth_type":"pwa","system_oauth_id":"DJ1iNBf5HiuIjSs7_1715823105441","system_oauth_new_id":"","system_version":"3.0.1","system_token":"","system_app_type":"","system_build":"","system_build_id":""}';
