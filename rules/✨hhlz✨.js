const hhlz = {
    ...
    var c1 = [
      {
        title: "推荐&漫画&小说&分类",
        id: "1&2&3&4&5",
        img: "https://raw.githubusercontent.com/ls125781003/tubiao/main/more/47.png&https://raw.githubusercontent.com/ls125781003/tubiao/main/more/70.png&https://raw.githubusercontent.com/ls125781003/tubiao/main/more/78.png&https://raw.githubusercontent.com/ls125781003/tubiao/main/more/67.png",
      },
    ];
    if (MY_PAGE == 1) {
  ...
  aes: $.toString(() => {
    ...
    function vodDecrypt(url) {
      ...
      let encryptedHexStr = CryptoJS.enc.Hex.parse(
        fetch(url, {
          toHex: true,
        })
      );
  ...
  recommend: () => {
    ...
    try {
      var data0 =
        '{"rankLimit":"10","product":"1","ver":"5.0.0","marketChannel":"luodiye","sign":"EB03A934638E973F518D4AB8012FCAED","sysVer":"10","appId":"1","osType":"2","limit":"10","time":"' +
        t +
        '","packageName":"cn.continue.me","proxyChannel":"luodiye","id":"1","page":"1","udid":"be4b3c9c-dcca-4544-8385-a9edbb060e68"}';
  ...
  manhuamore: () => {
    ...
    try {
      ...
      var data0 =
        ...
        pg +
        '","sysVer":"10","appId":"1","osType":"2","recommend_id":"' +
        id +
        '","time":"' +
        t +
        '","packageName":"cn.continue.me","proxyChannel":"luodiye","udid":"be4b3c9c-dcca-4544-8385-a9edbb060e68"}';
    ...
    try {
      ...
      chapter_list.forEach((data) => {
        d.push({
          ...
          desc: data.updated_at,
          url:
            "hiker://empty?#readTheme#&#autoPage#@rule=js:" +
            $.toString(() => {
              eval($.require("hhlz").rely($.require("hhlz").aes));
              let d = [];
    ...
    try {
      if (MY_PAGE == 1) {
        ...
        var cat1 = [
          {
            title:
              "全部&韩漫&日漫&3D漫画&全彩&Cosplay&写真&H漫&校园&乳交&口交&同人&出轨&榨精&母女&兽交&自慰&痴汉&真人&港漫&巨乳&\u4eba\u59bb&青春&剧情&萝莉&御姐&女仆&SM&百合&调教&同人志&NTR&多P&强迫&伪娘&男同&扶她&\u4e71\u4f26",
        ...
        var cat2 = [
          {
            title:
              "全部&长篇小说&短篇小说&武侠玄幻&灵异推理&网游小说&都市生活&现代情感&青春校园&\u4eba\u59bb熟妇&古文艳情&現代情感&师生&办公室 &\u4eba\u59bb&重口&偷情 &多人&凌辱&同人 &\u4e71\u4f26&换妻&巨乳&淫男欲女&丝袜性趣&家庭\u4e71\u4f26&调教",
      ...
      if (getMyVar("分类", "1") == 1) {
        ...
        var data0 =
          ...
          getMyVar("recommend_flag", "3") +
          '","marketChannel":"luodiye","sign":"C2EA530C24AA69E45510ACB2B68CD67B","page_num":"1","sysVer":"10","finished":"' +
          getMyVar("finished", "") +
          '","pay_status":"' +
          getMyVar("pay_status", "0") +
          '","appId":"1","cat":"' +
          getMyVar("cat1", "") +
          '","osType":"2","order_by":"0","time":"' +
          t +
          '","packageName":"cn.continue.me","proxyChannel":"luodiye","page_num":"' +
          pg +
          '","udid":"be4b3c9c-dcca-4544-8385-a9edbb060e68"}';
    ...
    try {
      ...
      if (getMyVar("搜索", "1") == 1) {
        var data0 =
          ...
          pg +
          '","sysVer":"10","appId":"1","osType":"2","time":"' +
          t +
